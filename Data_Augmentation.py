...
if __name__ == '__main__':
    # 图像和标签文件夹
    image_path = r"C:\Users\thefr\Desktop\datasetsV6\val\images"
    label_path = r"C:\Users\thefr\Desktop\datasetsV6\val\labels"
    save_path = r"C:\Users\thefr\Desktop\Data_AG"  # 结果保存位置路径，可以是一个不存在的文件夹
    # 运行
